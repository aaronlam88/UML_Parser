<?php
 ...
 $sql = "insert into form_element(username, password, verifyPassword, email, VerifyEmail, securityAnswer1,
 securityAnswer2, mobile, address, interestedArea) values
 ('$name2', '$password2', '$verifyPassword2','$email2', '$verifyEmail2', '$securityAnswer12',
 '$securityAnswer22','$cmobile2','$address2','$interestedArea2')";
